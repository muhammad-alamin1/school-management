...
const playLists = [
  {
    ...
    url: "https://www.youtube.com/playlist?list=PLgH5QX0i9K3o8Y-CKhmyodbfHAc9VSVOv",
  },
  {
    _id: 2,
    chapter: "Chapter 2",
    title: "Mathematics Chapter 4",
    url: "https://www.youtube.com/watch?v=PhcS7zZfd2g&list=PLEnvNvpjnLbG1sL0SSHPmq4SwXnLpiGZ0",
  },
  {
    _id: 2,
    chapter: "Chapter 2",
  ...
  return (
    <>
      ...
      <div className="sidebar-margin">
        <h3 className="my-4">Mathematics (Class 6)</h3>
